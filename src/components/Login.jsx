    ...
    <div className="bg-gray-50 flex justify-center gap-0">
      ...
      <div className=" h-80 -mx-8 min-h-screen flex items-center justify-start px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full mx-auto bg-white shadow-md rounded-lg p-8">
          <h2 className="text-center text-3xl font-extrabold text-gray-900">Iniciar sesión en tu cuenta</h2>
      ...
      <div className="-mx-8 min-h-screen flex items-center justify-end px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full mx-auto bg-white shadow-md rounded-lg p-8">
        <img className="w-80 h-80" src="./public/imglogin.svg"/>
