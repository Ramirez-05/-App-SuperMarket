...
from Api.schemas.user import GetUser, UserEmail, UserUpdate,UserStatus
from Api.crud.user import get_users,disabled_users,active_users, role_user, update_user, update_status
...
async def update_status_role(user: UserStatus,db: Session = Depends(get_session)):
      return update_status(user,db)